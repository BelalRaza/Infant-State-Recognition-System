...
\begin{table}[t]
  ...
  \begin{tabular}{lccc}
    ...
    \textbf{Model} & \textbf{Accuracy} & \textbf{Macro-F1} &
      \textbf{Inference (ms)} \\
    \midrule
    GMM (4 comp.) & [FILL] & [FILL] & [FILL] \\
    SVM (RBF)     & [FILL] & [FILL] & [FILL] \\
    HMM (5 st.)   & [FILL] & [FILL] & [FILL] \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{figure}[t]
  \centering
  % NOTE: replace with actual confusion matrix PNGs once generated
  ...
  \fbox{\parbox{0.9\columnwidth}{\centering\vspace{1.5cm}%
    Confusion matrix figures to be inserted after\\
    model evaluation is complete.\vspace{1.5cm}}}
