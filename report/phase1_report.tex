...
clip is resampled to 22\,050\,Hz and padded or truncated to a fixed
duration of 4~seconds (88\,200 samples).
...
\begin{enumerate}[nosep]
  \item \textbf{MFCC summary} — 40 MFCCs computed with a 2048-sample
        FFT window and 512-sample hop.  Each coefficient's time series
